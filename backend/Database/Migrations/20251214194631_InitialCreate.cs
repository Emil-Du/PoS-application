...
namespace backend.Database.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeServiceQualifications",
                columns: table => new
                {
                    EmployeeId = table.Column<int>(type: "integer", nullable: false),
                    ServiceId = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeServiceQualifications", x => new { x.EmployeeId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_EmployeeServiceQualifications_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeServiceQualifications_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "integer", nullable: false),
                    ReservationTime = table.Column<long>(type: "bigint", nullable: false),
                    AppointmentTime = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Street 123", 1, "foodcompany@gmail.com", "FOOD", "987654321" },
                    { 2, "Steet321", 1, "servicecompany@gmail.com", "SERVICES", "222333444" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Currency", "LocationId", "Name", "UnitPrice", "VatPercent" },
                values: new object[,]
                {
                    { 1, "Eur", 1, "Chicken", 7m, 21m },
                    { 2, "Eur", 1, "Fries", 1m, 21m },
                    { 3, "Eur", 1, "Beef", 10m, 21m },
                    { 4, "Eur", 2, "Haircut", 20m, 21m },
                    { 5, "Eur", 2, "Hairdye", 40m, 21m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeServiceQualifications_ServiceId",
